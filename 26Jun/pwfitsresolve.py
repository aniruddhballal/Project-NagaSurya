...
from scipy.ndimage import zoom  # Import zoom for resolution reduction
...
def plotty(ax, x, y, bvals, type, lmax, num_points_theta, num_points_phi, contnum):
    ...
    name = ''
    if type == 1:
        name = f'Original Data (reduced resolution)'
    elif type == 2:
...
reduction_factor = 2
b = zoom(b, (1/reduction_factor, 1/reduction_factor), order=1)
...
plot_filename = os.path.join(folder_path, f'plot_{timestamp}_reduced_res.png')
