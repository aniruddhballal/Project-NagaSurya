...
def process_all_csv_files():
    ...
    for csv_file in os.listdir(folder_name):
        if csv_file.endswith('.csv'):
            ...
            fits_file = f'E:/my_env1/we goin solar/13Jul/fits_files/hmi.Synoptic_Mr_small.{map_number}.fits'
            ...
            # Adding text to the bottom right corner of the first subplot
            ax1.annotate(
                f"Recons Avg: {recons_avg:.4f}\nFrac: {frac:.4f}",
