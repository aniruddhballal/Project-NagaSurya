...
def plotty(ax, x, y, bvals, type, carrington_map_number):
    ...
    # Get month and year from the mapping dictionary
...
# Define a mapping from Carrington map numbers to month and year
...
fits_folder = 'C:/Users/aniru/pyproj/my_env1/we goin solar/03Jul/fits_files'
